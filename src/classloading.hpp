...
struct ClassConstants {
    ...
    ClassFile *java_lang_NullPointerException;
    ...
    static const size_t primitive_count = static_cast<size_t>(Primitive::Void) + 1;
    ...
    PrimitiveConstants primitives[primitive_count] = {
...
struct BootstrapClassLoader {
    ...
    static ClassConstants const &constants() { return the_bootstrap_class_loader.m_constants; }
